...
BTC_0_dic = {'type': 'type_0', 'coin_No': 0, 'coin_Name': 'KRW-BTC', 'ma_duration_long': 69, 'ma_duration_mid': 29, 'ma_duration_short': 5, 'ratio_ema_long_rise': 1.0001, 'ratio_ema_mid_rise': 1.0004, 'recent_ratio_ema_long_plus': 0.0002, 'successive_rise': 5, 'ratio_ema_mid_long': 0.98, 'ref_vol_duration': 2.0, 'diff_m_l_factor': 0, 'coe_vol_comp': 1.0, 'under_long_duration': 17, 'recent_vol_duration': 0.1, 'sell_method_vol_cri': 0.2, 'ratio_peak_diff': 0.004, 'ratio_std_1': 0.1, 'ratio_std_2': 0.05, 'ratio_sell_ema_mid': 0.999, 'ratio_open_check': 1.002, 'ratio_prior_to_cur_long': 0.993, 'ratio_mean_long': 0, 'ratio_sell_forced': 0.03, 'ratio_sell_forced_peak': 0.1, 'bought_state': 0, 'bought_price': 0.0, 'bought_time': 0.0}

ETH_1_dic = {'type': 'type_0', 'coin_No': 1, 'coin_Name': 'KRW-ETH', 'ma_duration_long': 79, 'ma_duration_mid': 45, 'ma_duration_short': 13, 'ratio_ema_long_rise': 1.0, 'ratio_ema_mid_rise': 1.0004, 'recent_ratio_ema_long_plus': 0.0001, 'successive_rise': 11, 'ratio_ema_mid_long': 0.98, 'ref_vol_duration': 4.0, 'diff_m_l_factor': 0, 'coe_vol_comp': 1.0, 'under_long_duration': 20, 'recent_vol_duration': 0.19, 'sell_method_vol_cri': 0.3, 'ratio_peak_diff': 0.005, 'ratio_std_1': 0.05, 'ratio_std_2': 0.05, 'ratio_sell_ema_mid': 0.0, 'ratio_open_check': 1.0027, 'ratio_prior_to_cur_long': 0.998, 'ratio_mean_long': 0.1, 'ratio_sell_forced': 0.07, 'ratio_sell_forced_peak': 0.19, 'bought_state': 0, 'bought_price': 0.0, 'bought_time': 0.0}

WAVES_7_dic = {'type': 'type_0', 'coin_No': 7, 'coin_Name': 'KRW-WAVES', 'ma_duration_long': 94, 'ma_duration_mid': 37, 'ma_duration_short': 1, 'ratio_ema_long_rise': 1.0, 'ratio_ema_mid_rise': 1.0003, 'recent_ratio_ema_long_plus': 0, 'successive_rise': 9, 'ratio_ema_mid_long': 0.99, 'ref_vol_duration': 2.0, 'diff_m_l_factor': 0, 'coe_vol_comp': 0.5, 'under_long_duration': 15, 'recent_vol_duration': 0.11, 'sell_method_vol_cri': 0.2, 'ratio_peak_diff': 0.006, 'ratio_std_1': 0.1, 'ratio_std_2': 0.03, 'ratio_sell_ema_mid': 0.999, 'ratio_open_check': 1.0024, 'ratio_prior_to_cur_long': 0.995, 'ratio_mean_long': 0.5, 'ratio_sell_forced': 0.06, 'ratio_sell_forced_peak': 0.11, 'bought_state': 0, 'bought_price': 0.0, 'bought_time': 0.0}

STEEM_11_dic = {'type': 'type_0', 'coin_No': 11, 'coin_Name': 'KRW-STEEM', 'ma_duration_long': 71, 'ma_duration_mid': 37, 'ma_duration_short': 7, 'ratio_ema_long_rise': 1.0001, 'ratio_ema_mid_rise': 1.0003, 'recent_ratio_ema_long_plus': 0, 'successive_rise': 13, 'ratio_ema_mid_long': 0.99, 'ref_vol_duration': 1.0, 'diff_m_l_factor': 0.005, 'coe_vol_comp': 0.5, 'under_long_duration': 24, 'recent_vol_duration': 0.13, 'sell_method_vol_cri': 0.2, 'ratio_peak_diff': 0.005, 'ratio_std_1': 0, 'ratio_std_2': 0, 'ratio_sell_ema_mid': 0.0, 'ratio_open_check': 1.0037, 'ratio_prior_to_cur_long': 0.997, 'ratio_mean_long': 0.2, 'ratio_sell_forced': 0.08, 'ratio_sell_forced_peak': 0.13, 'bought_state': 0, 'bought_price': 0.0, 'bought_time': 0.0}
...
buyable_budget_ratio = [ ((1 / (No_of_buyable_items - 0)) - transaction_fee_ratio), ((1 / (No_of_buyable_items - 1)) - transaction_fee_ratio), ((1 / (No_of_buyable_items - 2)) - transaction_fee_ratio), ((1 / (No_of_buyable_items - 3)) - transaction_fee_ratio), ((1 / (No_of_buyable_items - 4)) - transaction_fee_ratio), ((1 / (No_of_buyable_items - 5)) - transaction_fee_ratio), ((1 / (No_of_buyable_items - 6)) - transaction_fee_ratio) ]
...
def type_0_buy_sell_normal (target_dic) :
    ...
    if target_dic['bought_state'] == 0 :   # 매수가 없는 상태라면 
        ...
        if (No_of_bought_items <= No_of_buyable_items) and         (DF_check['ratio_ema_long'][-4] > target_dic['ratio_ema_long_rise']) and (DF_check['ratio_ema_long'][-3] > target_dic['ratio_ema_long_rise']) and (DF_check['ratio_ema_long'][-2] > target_dic['ratio_ema_long_rise']) and         (DF_check['ratio_ema_long'][-1] > (target_dic['ratio_ema_long_rise'] + target_dic['recent_ratio_ema_long_plus'])) and (DF_check['ratio_ema_mid'][-1] > target_dic['ratio_ema_mid_rise']) and         (DF_check.iloc[-(target_dic['successive_rise'] + 2) : ]['rise_check_short'].sum() >= (target_dic['successive_rise'] - 2)) and         ((DF_check['ema_mid'][-1] / DF_check['ema_long'][-1]) > target_dic['ratio_ema_mid_long']) and         (DF_check['ref_vol_amount'][-2] >= target_dic['coe_vol_comp']) and (DF_check['ref_vol_amount'][-2] >= DF_check['ref_vol_amount'][-3]) and (DF_check['ref_vol_amount'][-2] >= DF_check['ref_vol_amount'][-4]) and         (-DF_check.loc[DF_check.iloc[-(target_dic['under_long_duration'] + 1) : -1]['diff_m_l'].idxmin()]['diff_m_l'] > (target_dic['diff_m_l_factor'] * DF_check['open'][-1])) :
            ...
            if (No_of_bought_items - 1) == 0 :
                ...
                investable_budget = get_balance(check_currency) * buyable_budget_ratio[5]
            elif (No_of_bought_items - 1) == 6 :
                investable_budget = get_balance(check_currency) * buyable_budget_ratio[6]
    ...
    if target_dic['bought_state'] == 1 :   # 매수가 되어 있는 상태라면
        ...
        print('(DF_check_peak[open][-1] < DF_check_peak[open][-2]) and (DF_check_peak[open][-1] < DF_check_peak[open][-4]) and (DF_check_peak[open][-1] < DF_check_peak[open][-7]) ___ {0} < {1}_{2}_{3}'.              format(DF_check_peak['open'][-1], DF_check_peak['open'][-2], DF_check_peak['open'][-4], DF_check_peak['open'][-7]))
        ...
        print ('DF_check_peak.loc[DF_check_peak.iloc[-13 : -1][ratio_prior_to_cur].idxmax()][ratio_prior_to_cur] < target_dic[ratio_open_check] _____ {0} < {1}'.               format(DF_check_peak.loc[DF_check_peak.iloc[-13 : -1]['ratio_prior_to_cur'].idxmax()]['ratio_prior_to_cur'], target_dic['ratio_open_check']))
        print ('DF_check_peak[ratio_prior_to_cur][-13 : -1].mean() < target_dic[ratio_prior_to_cur_long] _____ {0} < {1}'.               format(DF_check_peak['ratio_prior_to_cur'][-13 : -1].mean(), target_dic['ratio_prior_to_cur_long']))
        print ('DF_check_peak.iloc[-25 : -1][gap_prior_to_1].mean() < (target_dic[ratio_mean_long] * DF_check_peak.iloc[(50 * 24) : ][gap_prior_to_1].mean()) _____ {0} < {1}'.               format(DF_check_peak.iloc[-25 : -1]['gap_prior_to_1'].mean(), (target_dic['ratio_mean_long'] * DF_check_peak.iloc[(50 * 24) : ]['gap_prior_to_1'].mean())))
        ...
        if (time_elapse_bought > 24) and         (DF_check_peak.loc[DF_check_peak.iloc[-13 : -1]['ratio_prior_to_cur'].idxmax()]['ratio_prior_to_cur'] < target_dic['ratio_open_check']) and         ((DF_check_peak['ratio_prior_to_cur'][-13 : -1].mean() < target_dic['ratio_prior_to_cur_long']) or          (DF_check_peak.iloc[-25 : -1]['gap_prior_to_1'].mean() < (target_dic['ratio_mean_long'] * DF_check_peak.iloc[(50 * 24) : ]['gap_prior_to_1'].mean()))) :
            ...
            time.sleep(5)
            print('\nnow :', (datetime.datetime.now() + datetime.timedelta(seconds=(time_factor * 3600))))
            print('sell_transaction_result_by_ Gap_prior_to_1 :', transaction_sell)
        ...
        print ('DF_check_peak[low][-1] / DF_check_peak.loc[DF_check_peak.iloc[-(time_elapse_bought + 1) : -1][high].idxmax()][high]) < (1 - target_dic[ratio_sell_forced_peak]) _____ {0} < {1}'.               format((DF_check_peak['low'][-1] / DF_check_peak.loc[DF_check_peak.iloc[-(time_elapse_bought + 1) : -1]['high'].idxmax()]['high']), (1 - target_dic['ratio_sell_forced_peak'])))
        print ('DF_check_peak.iloc[-4 : -1][volume].mean() > (5 * DF_check_peak.iloc[-51 : -1][volume].mean()) _____ {0} > {1}'.               format(DF_check_peak.iloc[-4 : -1]['volume'].mean(), (5 * DF_check_peak.iloc[-51 : -1]['volume'].mean())))            
        
        if ((DF_check_peak['low'][-1] / DF_check_peak.loc[DF_check_peak.iloc[-(time_elapse_bought + 1) : -1]['high'].idxmax()]['high']) < (1 - target_dic['ratio_sell_forced_peak'])) and         (DF_check_peak.iloc[-4 : -1]['volume'].mean() > (5 * DF_check_peak.iloc[-51 : -1]['volume'].mean())) :
            
            transaction_sell = upbit.sell_market_order(target_coin, get_balance(target_coin[4:]))  # 시장가에 매도
            time.sleep(5)
            print('\nnow :', (datetime.datetime.now() + datetime.timedelta(seconds=(time_factor * 3600))))
            print('sell_transaction_result_by_ sell_forced_by_Peak :', transaction_sell)
